...
@onready var player_ship: CharacterBody2D = get_tree().get_first_node_in_group("player_ship") as CharacterBody2D
...
func _apply_to_player() -> void:
	...
	player_ship.set_control_style(WorldState.control_style as player_ship.ControlStyle)
